...
ventanaPrincipal.geometry("500x420")
...
titulo_Ayuda = tk.Label(ventanaPrincipal, text="Ayuda", font = ("Bold", 13), bg = "#FFC300", padx=50, pady=5)
...
boton_Salir = tk.Button(ventanaPrincipal, text="Salir", font=10, padx=57, bg="#dc7633")
